...
![تنوع ژنتیکی]({static}/images/mech01_mutation-e1616207371250.png)
...
![تولیدمثل افتراقی]({static}/images/natselect02_birdeatingbeetles.png)

**۳) وراثت**

سوسک‌های قهوه‌ای که بقا یافته‌اند فرزندانی با رنگ قهوه‌ای دارند چون این خصوصیت ریشهٔ ژنتیکی دارد.

![وراثت]({static}/images/natselect03_simple_beetle_brown_tree.png)
...
![انتخاب طبیعی]({static}/images/natselect04_allbrownbeetles.png)
