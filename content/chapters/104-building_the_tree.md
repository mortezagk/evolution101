...
Slug: the-history-of-life-looking-at-the-patterns/building-the-tree
...
Redirect_from: chapter-1/04-building-the-tree.html
Author: mortezagk
...
برای ساختن یک درخت فیلوژنتیکی مثل آنچه در ادامه می‌بینید، زیست‌شناسان اقدام به جمع‌آوری داده‌هایی در مورد ویژگی‌های جاندار مورد نظر خود می‌کنند. ویژگی‌ها، خصیصه‌های قابل وراثتی هستند که می‌توان آنها را در موجودات مختلف سنجید، مثل ویژگی‌های فیزیکی (ریخت‌شناختی[^۱])، توالی‌های ژنتیکی، یا صفات رفتاری.
...
<center markdown="1">چهار اندامی یک ویژگی اشتقاقیِ مشترکِ کلادِ چهاراندامان[^۵] است؛ جایی که چهار اندام زیرین شکل گرفت با علامت مشخص شده است.<br>*درخت برگرفته از: Irisarri, I., Baurain, D., Brinkmann, H., Delsuc, F., Sire, J.-Y., Kupfer, A., … and Philippe, H., 2017. Phylotranscriptomic consolidation of the jawed vertebrate timetree. Nat Ecol Evol 1, 1370–1378.*</center>
