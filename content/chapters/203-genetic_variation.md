...
------
بدون تنوع ژنتیکی، برخی سازوکارهای کلیدیِ تغییرِ فرگشتی، مانند انتخاب طبیعی و رانش ژن، قادر به عمل نیستند.

سه منشأ اصلی تنوع ژنتیکی وجود دارد که به زودی بیشتر در مورد آنها صحبت می‌کنیم:

**۱) جهش‌ها** تغییراتی در اطلاعاتِ موجود در مادهٔ ژنتیکی هستند. (برای بیشترِ جانداران، این یعنی تغییر در توالیِ DNA.) حتی یک جهش می‌تواند تاثیراتِ بزرگی داشته باشد، ولی در بسیاری از موارد، اساسِ تغییرِ فرگشتی انباشتِ تعداد زیادی از جهش‌ها با اثراتِ کوچک است.

**۲) جریان ژن** هرگونه جابه‌جاییِ مادهٔ ژنتیکی از یک جمعیت به جمعیت دیگر است (مثلاً از طریق مهاجرت) و منشأ مهمی برای تنوع ژنتیکی است.
