...
Slug: the-history-of-life-looking-at-the-patterns/the-family-tree
...
Redirect_from: chapter-1/01-family-tree.html
Author: mortezagk
...
![مجموعه‌ای از فیلوژنی‌ها که فرایند بزرگ‌نمایی شاخهٔ یوکاریوت‌ها را نشان می‌دهد: درخت حیات، یوکاریوت‌ها، اپیستوکونت‌ها و مهره‌داران.]({static}/images/YAH_16_17_3_2025-1-scaled.png)
<center markdown="1">از درخت حیات تا مهره‌داران: درخت حیات (برگرفته از Hug و همکاران، ۲۰۱۶)، یوکاریوت‌ها، اپیستوکونت‌ها و مهره‌داران</center>
