...
![چهار اندامی یک ویژگی اشتقاقیِ مشترکِ کلادِ چهاراندامان است.](https://evolution.berkeley.edu/wp-content/uploads/2021/10/03-Vertebrate_homology.png){: width="792" height="528" loading="lazy" }
<div class="caption" markdown="1">یک فیلوژنی که نشان می‌دهد چهار اندام زیرین کجا شکل گرفت.<br>*درخت برگرفته از: Irisarri, I., Baurain, D., Brinkmann, H., Delsuc, F., Sire, J.-Y., Kupfer, A., … and Philippe, H., 2017. Phylotranscriptomic consolidation of the jawed vertebrate timetree. Nat Ecol Evol 1, 1370–1378.*</div>
...
![ساختار بال](https://evolution.berkeley.edu/wp-content/uploads/2021/11/bat_bird_wings_english-300x98.png){: width="500" height="164" loading="lazy" }
<div class="caption" markdown="1">مقایسهٔ ساختار بال یک پرنده و یک خفاش</div>

بال‌های خفاش از لایه‌های پوست که بین استخوانِ انگشتان و بازو گسترش یافته تشکیل شده است. بال‌های پرنده از پرهایی تشکیل شده که در تمامِ طولِ دست گسترش یافته است. این عدمِ تجانسِ ساختاری نشان می‌دهد که بال‌های پرنده و خفاش از یک نیای مشترکِ بال‌دار به ارث نرسیده است. این ایده در فیلوژنیِ زیر، که بر پایهٔ تعداد زیادی از ویژگی‌های دیگر ساخته شده، نشان داده شده است.

![بال‌ها در پرندگان و خفاش‌ها](https://evolution.berkeley.edu/wp-content/uploads/2021/10/wings_phylo_eng-300x198.png){: width="220" height="146" loading="lazy" }
<div class="caption" markdown="1">یک فیلوژنی که نشان می‌دهد بال‌ها در پرندگان و خفاش‌ها به صورت جداگانه فرگشت یافته است.</div>
