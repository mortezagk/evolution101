...
![مرغ کریچ‌ساز ساتن (چپ) کانالی بین ترکه‌های ایستاده می‌سازد و با اشیاء آبی روشن تزئین می‌کند؛ مرغ کریچ‌ساز مک‌گرگور (راست) برجی بلند از ترکه‌ها می‌سازد و با تکه‌های زغال تزئین می‌کند.](https://evolution.berkeley.edu/wp-content/uploads/2021/04/bowerbirds.jpg){: width="682" height="234" loading="lazy" }

<div class="caption" markdown="1">
مرغ‌های کریچ‌ساز آشیانه‌های آراسته‌ای می‌سازند و آنها را با رنگ‌های مختلف تزئین می‌کنند تا ماده‌ها را جلب کنند. مرغ کریچ‌ساز ساتن (چپ) کانالی بین ترکه‌های ایستاده می‌سازد، و آن را با اشیاء آبی روشن تزئین می‌کند، در حالی که مرغ کریچ‌ساز مک‌گرگور (راست) برجی بلند از ترکه‌ها می‌سازد و آن را با تکه‌های زغال تزئین می‌کند. تفاوت‌های فرگشتی در آیین جفت‌گیری، مثل ساخت آشیانه، می‌تواند به گونه‌زایی کمک کند.<br>*عکس مرغ کریچ‌ساز ساتن از Graeme Guy. عکس مرغ کریچ‌ساز مک‌گرگور از Stephen و Melinda Pruett-Jones.*
</div>
...
![اندام‌های جنسی](https://evolution.berkeley.edu/wp-content/uploads/2021/09/damselflypenes-1024x318.png){: width="1024" height="318" loading="lazy" }
<div class="caption" markdown="1">این آلت‌های نری که متعلق به سنجاقک‌های سوزنی است، نشان می‌دهد آلت تناسلی حشرات چه قدر می‌تواند پیچیده باشد.<br>*تصویر برگرفته از Eberhard, W.G. 1985. Sexual Selection and Animal Genitalia. Harvard University Press.*</div>
...
![انزوای جغرافیایی](https://evolution.berkeley.edu/wp-content/uploads/2021/09/drosophila_scene_2-1024x449.png){: width="1024" height="449" loading="lazy" }
<div class="caption" markdown="1">انزوای جغرافیایی می‌تواند یک رویداد گونه‌زایی را شروع کند -ولی تغییرات ژنتیکی برای تکمیل این فرایند ضروری است.</div>
...
![انزوای جغرافیایی](https://evolution.berkeley.edu/wp-content/uploads/2021/09/Drosophila_scene_3_2-1024x450.png){: width="1024" height="450" loading="lazy" }
<div class="caption" markdown="1">فشارهای انتخابیِ متفاوت در دو جزیره می‌تواند تمایزِ گونهٔ جدید را کامل کند.</div>
...
![انزوای جغرافیایی](https://evolution.berkeley.edu/wp-content/uploads/2021/09/drosophila_scene7-1024x449.png){: width="1024" height="449" loading="lazy" }
