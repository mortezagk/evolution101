...
![مرغ کریچ‌ساز ساتن (چپ) کانالی بین ترکه‌های ایستاده می‌سازد و با اشیاء آبی روشن تزئین می‌کند؛ مرغ کریچ‌ساز مک‌گرگور (راست) برجی بلند از ترکه‌ها می‌سازد و با تکه‌های زغال تزئین می‌کند.]({static}/images/bowerbirds.jpg)
...
![اندام‌های جنسی]({static}/images/damselflypenes.png)
...
![انزوای جغرافیایی]({static}/images/drosophila_scene_2-1.png)
...
![انزوای جغرافیایی]({static}/images/Drosophila_scene_3_2-1.png)
...
![انزوای جغرافیایی]({static}/images/drosophila_scene7.png)
