...
Slug: the-history-of-life-looking-at-the-patterns/trees-not-ladders
...
Redirect_from: chapter-1/03-trees-not-ladders.html
Author: mortezagk
...
![زنجیرهٔ عظیم هستی]({static}/images/chain_of_being-1.png)
...
![فیلوژنی گیاهان]({static}/images/trees_not_ladders_mossfern-1.png)

پس به‌یاد داشتن این سه نکته در هنگام مطالعهٔ یک فیلوژنی مهم است:

**۱)** فرگشت طرحی از روابط بین نسب‌ها ایجاد می‌کند که به شکلِ یک درخت است، نه یک نردبان. ![فیلوژنی گیاهان]({static}/images/trees_not_ladders_notladders.png)

**۲)** این که ما ترجیح می‌دهیم فیلوژنی‌ها را از چپ به راست مطالعه کنیم، هیچ ارتباطی با سطح «پیشرفت» ندارد. ![فیلوژنی گیاهان]({static}/images/trees_not_ladders_northis.png)

**۳)** برای هر رویدادِ گونه‌زایی روی یک فیلوژنی، انتخاب این که کدام نسب سمت راست و کدام سمت چپ قرار گیرد اختیاری است. فیلوژنی‌های زیر یکسان هستند: ![فیلوژنی گیاهان]({static}/images/trees_not_ladders_equalmoss.png)
...
![فیلوژنی گیاهان]({static}/images/trees_not_ladders_humans-1.png)
